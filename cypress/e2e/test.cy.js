  ...
  data.map(({ submission_link: url, id }) => {
    if (url && url.length) {
      ...
      it(`Check if navbar components are linked to respective elements`, () => {
        ...
        cy.get(".nav-link.about", { multiple: true }).click();
        ...
        cy.visit(url);
        cy.isInViewport("#nav-menu");
        cy.get(".nav-link.skills", { multiple: true }).click();
        ...
        cy.visit(url);
        cy.isInViewport("#nav-menu");
        cy.get(".nav-link.projects", { multiple: true }).click();
        ...
        cy.visit(url);
        cy.isInViewport("#nav-menu");
        cy.get(".nav-link.contact", { multiple: true }).click();
        ...
        cy.isInViewport("#nav-menu");
        cy.get(".nav-link.home", { multiple: true }).click();
